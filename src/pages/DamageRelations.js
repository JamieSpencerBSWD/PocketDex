    ...
    return (
        <div style={{textAlign:"center"}}>
            ...
            <div style={{padding:"2%",display:"flex", justifyContent: "space-evenly", flexDirection:"row"}}>
                ...
                <div><div style={{display:"flex", flexDirection:"row", justifyContent: "space-evenly"}}><div style={{padding:"1%"}} className='perfectSquare half'><p className='centeredText'>x0.5</p></div><div style={{padding:"1%"}} className='quarter'><p className='centeredText'>x0.25</p></div></div> Not Very Effective (50% Damage / 25% Damage)</div>
